                        ...
                        <div className="footer__row">
                            <div className="footer__card">
                                <ul className="footer__list">
                                    <li className="footer__item"><a className="footer__link" href="">" ЗАНГИ OTA ЗИЁРАТГОХИ " мемориальный комплекс</a></li>
                                   
                                </ul>
                            </div>
                            <div className="footer__card">
                                <ul className="footer__contact-list">
                                    <li className="footer__contact-item"><h4 className="footer__contact-title">Ташкентская область, Зангиатинский район, улица А. Темура, 24.
                                        Индекс 111809, Факс: (0370) 975-81-69
                                    </h4></li>
