        ...
        <div className='container'>
          <div className='header__row'>
            ...
            <ul className={header__list}>
              <li className='header__item'><a className='header__link' href='#header'>О нас</a></li>
              <li className='header__item'><a className='header__link' href='#galereya'>Лекции</a></li>
              <li className='header__item'><a className='header__link' href='#namoz-vaqt'>Галерея</a></li>
              <li className='header__item'><a className='header__link' href='#boglanish'>История</a></li>
            </ul>
