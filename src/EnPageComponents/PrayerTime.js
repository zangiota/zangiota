                            ...
                            return (
                                <div className="prayer-time__row" key={i}>
                                    <div className="prayer-time__card">
                                        ...
                                        <p className="prayer-time__title">Fajr</p>
                                    </div>
                                    <div className="prayer-time__card">
                                        <h2 className="prayer-time__time">{data.Sunrise}</h2>
                                        <p className="prayer-time__title">Sunrise</p>
                                    </div>
                                    <div className="prayer-time__card">
                                        <h2 className="prayer-time__time">{data.Dhuhr}</h2>
                                        <p className="prayer-time__title">Dhuhr</p>
                                    </div>
                                    <div className="prayer-time__card">
                                    ...
                                    <div className="prayer-time__card">
                                        ...
                                        <p className="prayer-time__title">Maghrib</p>
                                    </div>
                                    <div className="prayer-time__card">
                                        <h2 className="prayer-time__time">{data.Isha}</h2>
                                        <p className="prayer-time__title">Isha</p>
                                    </div>
                                </div>
                            );
                        })
