        ...
        <div className='container'>
          <div className='header__row'>
            ...
            <ul className={header__list}>
              <li className='header__item'><a className='header__link' href='#header'>About us</a></li>
              <li className='header__item'><a className='header__link' href='#galereya'>Lectures</a></li>
              <li className='header__item'><a className='header__link' href='#namoz-vaqt'>Gallery</a></li>
              <li className='header__item'><a className='header__link' href='#boglanish'>History</a></li>
            </ul>
